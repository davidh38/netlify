...
[[file:Screenshot from 2020-09-12 13-43-49.png][This how it looks like:]]
...
** Version Control
- dont forget to type a message in the commit message
- stage file s on unstaged file or SPC g S
** Package Manager
SPC : package install
    treemacs
